            ...
            <div className="resource-wrapper">
              <div className="row border-bottom">
                <div className="col-sm-12 col-md-4">
                  <div className="info">
                    <img className="image-profile avatar" src="Assets/avatar.png" />
                    ...
                    {/*Modal: Name*/}
                    <a>
                      <div className="img-fluid z-depth-1 name span-inline" alt="video" data-toggle="modal" data-target="#modal1">Task Name 1</div>
                    </a>
                            ...
                            <div className="popup-profile-wrapper">
                              ...
                              <div className="profile">
                                <div className="main">
                                  ...
                                  <div className="form-group has-search form-group-search">
                                    <span className="fa fa-search form-control-feedback" />
                                    <input type="text" className="form-control" placeholder="All Resources" />
                                  </div>
                                </div>
                              </div>
                              <div className="row border-bottom">
                                <div className="col-sm-12 col-md-4">
                                  <div className="info">
                                    {/*Modal: Name*/}
                                    <img className="image-profile" src="Assets/image.png" />
                                    <div className="name span-inline">Heba Fouad</div>
                                    <div className="resource-title">Associate Project Manager Development</div>
                                    <div className="m-left-85">
                                ...
                                <div className="col-sm-12 col-md-3">
                                  ...
                                  <div className="assign-image-popup">
                                    <img className="center-image" src="Assets/plus.png" />
                                  </div>
                                </div>
                              </div>
                              <div className="row border-bottom">
                    ...
                    <a>
                      <div data-toggle="modal" data-target="#modal7" className="assigning">
                        <div className="assign-image display-inline">
                          <img className="center-image-popup" src="Assets/plus.png" />
                        </div>
                        <div className="assign-text display-inline">Assigning resource</div>
                      </div>
                    </a>
                  </div>
                </div>
                ...
                <div className="col-sm-12 col-md-3">
                            ...
                            <div className="row border-bottom">
                              ...
                              <div className="col-sm-12 col-md-3">
                                ...
                                <div className="assign-image-popup-cancel">
                                  <img className="center-image" src="Assets/Group.png" />
                                </div>
                              </div>
                            </div>
                            <div className="row border-bottom">
                  ...
                  <a>
                  </a><div data-toggle="modal" data-target="#modal2" className="icon-writing z-depth-1 display-inline edit-margin"><a>
              ...
              <div className="row border-bottom">
                <div className="col-sm-12 col-md-4">
                  <div className="info">
                    <img className="image-profile avatar" src="Assets/pic.png" />
                    <div className="modal fade" id="modal1" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      <div className="modal-dialog modal-lg" role="document">
                        <div className="modal-content">
                          <div className="modal-body mb-0 p-0">
                    ...
                    {/*Modal: Name*/}
                    <a>
                      <div className="img-fluid z-depth-1 name span-inline" alt="video" data-toggle="modal" data-target="#modal1">Task Name 2</div>
                    </a>
                    <div className="m-left-85">
                      <div className="available display-inline">
                      </div>
                ...
                <div className="col-sm-12 col-md-3">
                  ...
                  <div className="modal fade" id="modal3" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg delete-cont" role="document">
                      {/*Content*/}
                      <div className="modal-content">
                        {/*Body*/}
                        <div className="modal-body mb-0 p-0">
              ...
              <div className="row border-bottom">
                <div className="col-sm-12 col-md-4">
                  <div className="info">
                    ...
                    {/*Modal: Name*/}
                    <a>
                      <div className="img-fluid z-depth-1 name span-inline" alt="video" data-toggle="modal" data-target="#modal1">Task Name 3</div>
                    </a>
                    <div className="m-left-85">
                      <div className="available display-inline">
                      </div>
